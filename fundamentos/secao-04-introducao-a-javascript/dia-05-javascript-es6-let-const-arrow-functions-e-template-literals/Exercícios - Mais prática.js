...
let statusMotor2 = 'desligado';

const motor2 = () => (statusMotor2 === 'ligado' ? `O motor está ${statusMotor2}` : `O motor está ${statusMotor2}`)

console.log(motor2(statusMotor2))
