...
const orderModifier = (fullOrder) => {
  ...
  return `Olá, ${fullOrder.name}, o valor total de seu pedido de ${
    Object.keys(fullOrder["order"]["pizza"])[0]
  }, ${Object.keys(fullOrder["order"]["pizza"])[1]} e ${
    fullOrder.order.drinks.coke.type
  } é R$ ${fullOrder.payment.total.toFixed(2)}`;
};
