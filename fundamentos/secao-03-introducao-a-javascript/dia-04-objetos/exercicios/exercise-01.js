...
for (index = 0; index < reader["favoriteBooks"].length; index += 1) {
  booksQuantity += 1;
}

if (booksQuantity === 1) {
  console.log(`${reader.name} tem ${booksQuantity} livro favorito.`);
} else if (booksQuantity > 1) {
  console.log(`${reader.name} tem ${booksQuantity} livros favoritos.`);
}
